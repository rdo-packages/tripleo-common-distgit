...
# TODO remove when https://review.openstack.org/587239 is merged
touch %{buildroot}%{_bindir}/tripleo-container-image-prepare
...
%changelog
* Tue Sep 25 2018 RDO <dev@lists.rdoproject.org> 9.4.0-1
- Update to 9.4.0
