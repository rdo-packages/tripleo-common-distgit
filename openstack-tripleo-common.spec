...
%changelog
* Mon Jun 18 2018 RDO <dev@lists.rdoproject.org> 5.4.9-1
- Update to 5.4.9

* Mon Apr 23 2018 RDO <dev@lists.rdoproject.org> 5.4.8-1
- Update to 5.4.8

* Wed Nov 22 2017 RDO <dev@lists.rdoproject.org> 5.4.7-1
- Update to 5.4.7

* Wed Nov 15 2017 RDO <dev@lists.rdoproject.org> 5.4.6-1
- Update to 5.4.6

* Fri Nov 03 2017 RDO <dev@lists.rdoproject.org> 5.4.5-1
- Update to 5.4.5

* Wed Oct 11 2017 rdo-trunk <javier.pena@redhat.com> 5.4.4-1
- Update to 5.4.4

* Mon Sep 04 2017 rdo-trunk <javier.pena@redhat.com> 5.4.3-1
- Update to 5.4.3

* Thu Apr 27 2017 rdo-trunk <javier.pena@redhat.com> 5.4.2-1
- Update to 5.4.2

* Wed Jan 04 2017 Jon Schlueter <jschluet@redhat.com> 5.4.1-1
- Update to 5.4.1
