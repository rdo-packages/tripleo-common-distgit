...
%changelog
* Wed Aug 18 2021 Yatin Karel <ykarel@redhat.com> - 15.3.0-2
- Apply Patch for redhat-release rpm cleanup in CentOS

* Mon Jul 19 2021 RDO <dev@lists.rdoproject.org> 15.3.0-1
- Update to 15.3.0

* Tue Jun 08 2021 RDO <dev@lists.rdoproject.org> 15.2.1-1
- Update to 15.2.1

* Mon May 10 2021 RDO <dev@lists.rdoproject.org> 15.2.0-1
- Update to 15.2.0
